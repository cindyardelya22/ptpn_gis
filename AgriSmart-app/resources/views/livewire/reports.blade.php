<div class="p-6 lg:p-8 space-y-6 max-w-7xl mx-auto" x-data="{ activeTab: @entangle('activeTab') }">
    ...
    <div class="flex items-center gap-2 overflow-x-auto pb-2 scrollbar-hide">
        ...
        @if(in_array('fertility', $allowedTabs))
        ...
        @if(in_array('recommendation', $allowedTabs))
        ...
        @if(in_array('history', $allowedTabs))
        ...
        <p class="text-sm text-slate-400 italic">Anda tidak memiliki akses ke laporan manapun.</p>
        @endif
    </div>
